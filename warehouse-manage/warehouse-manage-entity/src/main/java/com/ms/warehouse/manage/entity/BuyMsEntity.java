 ...
 */
@TableName("t_buy_ms")
public class BuyMsEntity extends BaseEntity {
	 ...
	 */
	public BuyMsEntity(Long itemId,java.math.BigDecimal quantity,java.math.BigDecimal price,java.util.Date buyTime,java.util.Date existTime,String remark,java.util.Date createtime){
		this();
		this.itemId = itemId;
		this.quantity = quantity;
		this.price = price;
	...
	public String toString() {
		return new StringBuilder().append("BuyMsEntity[")
	...
	public boolean equals(Object obj) {
		if (obj == null)
			return false;
		if(obj instanceof BuyMsEntity == false)
			return false;
		if(this == obj)
			return true;
		BuyMsEntity other = (BuyMsEntity)obj;
