 ...
 * @since 1.0
 */
@TableName("t_opinion_ms")
public class TopinionMsEntity extends BaseEntity {
    ...
    /** set 处理状态 1-已反馈 2-已处理. */
	public void setHandleType(String handleType) {
		this.handleType = handleType;
	}
	
	/** get 处理状态 1-已反馈 2-已处理. */
	 ...
	 * @param handleType			处理状态 1-已反馈 2-已处理
	 * @param reText			反馈内容
	 * @param reTime			反馈时间
	 * @param reRewardText			奖励内容
	 */
	public TopinionMsEntity(String type,String title,String remark,java.util.Date createtime,Long createPeo,String handleType,String reText,java.util.Date reTime,String reRewardText){
		this();
		this.type = type;
		this.title = title;
		this.remark = remark;
	...
	public String toString() {
		return new StringBuilder().append("TopinionMsEntity[")
	...
	public boolean equals(Object obj) {
		if (obj == null)
			return false;
		if(obj instanceof TopinionMsEntity == false)
			return false;
		if(this == obj)
			return true;
		TopinionMsEntity other = (TopinionMsEntity)obj;
