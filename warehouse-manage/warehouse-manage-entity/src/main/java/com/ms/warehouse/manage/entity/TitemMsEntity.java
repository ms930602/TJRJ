 ...
 */
@TableName("t_item_ms")
public class TitemMsEntity extends BaseEntity {
	 ...
	 * @param remark			备注
	 */
	public TitemMsEntity(Long gameId,String name,String type,java.util.Date createtime,java.util.Date updatetime,byte[] remark){
		this();
		this.gameId = gameId;
		this.name = name;
		this.type = type;
	...
	public String toString() {
		return new StringBuilder().append("TitemMsEntity[")
	...
	public boolean equals(Object obj) {
		if (obj == null)
			return false;
		if(obj instanceof TitemMsEntity == false)
			return false;
		if(this == obj)
			return true;
		TitemMsEntity other = (TitemMsEntity)obj;
