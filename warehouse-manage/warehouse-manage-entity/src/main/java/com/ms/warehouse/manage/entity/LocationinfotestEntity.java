 ...
 * @since 1.0
 */
@TableName("t_base_locationinfotest")
public class LocationinfotestEntity extends BaseEntity {
	 ...
	 */
	public LocationinfotestEntity(Long areaId,Long areaBlock,Long areaRow,Long areaNum,Long upDown,Long status,String localCode,String localRfid,java.util.Date createdDate,Long createdPersonId,String createdPerson,java.util.Date updatedDate,Long updatedPersonId,String updatedPerson,String descript,Long groupNo,Long isonthewall){
		this();
		this.areaId = areaId;
		this.areaBlock = areaBlock;
		this.areaRow = areaRow;
	...
	public String toString() {
		return new StringBuilder().append("LocationinfotestEntity[")
	...
	public boolean equals(Object obj) {
		if (obj == null)
			return false;
		if(obj instanceof LocationinfotestEntity == false)
			return false;
		if(this == obj)
			return true;
		LocationinfotestEntity other = (LocationinfotestEntity)obj;
