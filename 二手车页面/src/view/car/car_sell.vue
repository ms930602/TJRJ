<template>
	<yd-layout id='carSell'>
		...
		<div class="sell_lc">
			<div class="lc_title">
				<div class="lc_title_c">
					<div class="henxian"></div>
					<div class="lc_name">卖车流程</div>
					<div class="henxian"></div>
				</div>
			</div>
			<div class="lc_list_f">
...
<style lang='scss'>
	#carSell {
		...
		.sell_car {
			padding: .3rem 0;
			box-shadow: 0 0 3px 3px rgba(221, 221, 221, .5);
			width: 93.33%;
			margin: .3rem auto 0;
			.popup_input {
				width: 90%;
			...
			.lc_list_f {
				...
				.lc_list {
					...
					&:after {
						...
						border-top: .07rem solid #D6D6D6;
						border-right: .07rem solid #D6D6D6;
