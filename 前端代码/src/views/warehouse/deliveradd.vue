			                ...
			                <el-form-item label="是否紧急出库"  prop='isUrgent'>
					      	...
					      	<el-row>
					      		 <el-form-item label="发货要求"  prop='deliveryRequire'>
						    		<inputItem style="width: 200px;" :value.sync="form.deliveryRequire"  :maxlength="45" ></inputItem>
						      	</el-form-item>
				                <el-form-item label="物流单备注"  prop='shipmentRemark'>
						   	 		<inputItem style="width: 200px;" :value.sync="form.shipmentRemark"  :maxlength="45" ></inputItem>
						    	</el-form-item>
					              <el-form-item label="备注"  prop='remark'>
						    		<inputItem style="width: 200px;" :maxlength="45" :value.sync="form.remark" ></inputItem>
						      	</el-form-item>
					      	</el-row>
				  </el-form>
		  		</div>
		...
		<el-row>
				...
				<el-card class="box-card" style="margin-right: 5px; margin-top: 10px; margin-left: 5px;" shadow="hover">
				  ...
				  <!--<div style="margin-left: 5px; margin-bottom: 5px;">-->
					<el-table :data="detailtableData" border style="width: 100%" @row-click="detailClick" highlight-current-row>
					   <el-table-column prop="materName" label="卷烟名称" width="100">
						...
						<el-table-column prop="materCode"  label="卷烟编码" width="100">
							<template slot-scope="scope">
						...
						<el-table-column prop="materVersion" label="版本" width="80">
							<template slot-scope="scope">
						...
						<el-table-column prop="subverName"label="子版本" width="70"> </el-table-column>
					    <el-table-column prop="usableQuality"  label="可操作(件)" width="80"> </el-table-column>
					    <el-table-column prop="qualityBox" label="数量(件)" width="120"> 
					    	<template slot-scope="scope">
				              	<el-input-number v-model="scope.row.qualityBox" @change="qualityBoxchange(scope.row)" style="width: 100px;" @keyup.native.enter="automatic(scope.row)" controls-position="right" :precision="0" :step="20" :min="0" :max="99999" label="数量"></el-input-number>
				            </template>
					    </el-table-column>
					    <el-table-column prop="qualityBoxunit"  label="数量(万支)" width="80"> </el-table-column>
			...
			<el-col :span="10">
				<el-card class="box-card" style="margin-right: 5px; margin-top: 10px; margin-left: 5px;" shadow="hover">
				  ...
				  <div style="margin-left: 5px; margin-bottom: 5px; margin-top: 13px; padding: 5px;">
					<elemTable style="padding: 0;" highlight-current-row  :dataList="dataList" :currentPage='pageNum' :pageSize="pageSize" :pageTotal="pageTotal" :loading="dataLoading" @sizeChange="handleSizeChange" @currentChange="handleCurrentChange">
					    ...
					    <el-table-column prop="cigsmokeQuality" label="存量(件)" min-width="70">
					    	<template slot-scope="scope">
					    ...
					    <el-table-column prop="realoutQuality" label="出量(件)" min-width="55">
					    	<template slot-scope="scope">
			...
			<div style="float: right; padding:20px ;">
			    ...
			    <el-button type="info" @click="checkdetailsquickBox('form')">保存为草稿</el-button>
...
//	        ]
  ...
  mounted() {
  	...
  	this.form.deliveryDate = this.getToday;
  	this.form.contractDate = this.getToday;
  	this.form.shipmentDate = this.getToday;
	...
	this.getAllMerchantEntitytravellingtrader();
  	//this.getAllVehicleinfoEntity();//（暂时没有数据）
  	//this.getAllDriversEntity();//（暂时没有数据）
...
//			name: 'strategy/getOutStockStrategy', 
			param: {
				materCode:row.materCode,
