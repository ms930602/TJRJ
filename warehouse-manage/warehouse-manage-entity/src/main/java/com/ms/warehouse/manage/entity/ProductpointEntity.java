 ...
 * @since 1.0
 */
@TableName("t_mater_productpoint")
public class ProductpointEntity extends BaseEntity {
	...
	@JsonIgnore
	public String getProCodeByLike() {
		return "%"+this.proCode+"%";
	}
	...
	@JsonIgnore
	public String getProNameByLike() {
		return "%"+this.proName+"%";
	}
	 ...
	 */
	public ProductpointEntity(String dataId,String proCode,String proName,String status,java.util.Date createdDate,String createdPerson,java.util.Date updatedDate,String updatedPerson){
		this();
		this.dataId = dataId;
		this.proCode = proCode;
		this.proName = proName;
	...
	public String toString() {
		return new StringBuilder().append("ProductpointEntity[")
			.append("Id=").append(getId()).append(", ")
			.append("DataId=").append(getDataId()).append(", ")
			.append("ProCode=").append(getProCode()).append(", ")
			.append("ProName=").append(getProName()).append(", ")
	...
	public boolean equals(Object obj) {
		if (obj == null)
			return false;
		if(obj instanceof ProductpointEntity == false)
			return false;
		if(this == obj)
			return true;
		ProductpointEntity other = (ProductpointEntity)obj;
