<template>
	...
	<div>
		<el-row>
			<el-card class="box-card" style="margin-right: 5px; margin-left: 5px;" shadow="hover">
				<div slot="header" class="clearfix">
				    <span>编辑入库单：{{this.form.orderNumber}}</span>
				</div>
		  	<div>
			<el-form class="modal-form" :inline="true" :model="form" :rules="rules" ref="form" label-width="100px">
                	...
                	<!--<el-col :span="6">
		                <el-form-item label="入库订单编号"  prop='orderNumber'>
		              	...
		              	<el-form-item label="入库单号"  prop='orderNumber'  v-if="showid">
			    			<inputItem :value.sync="form.orderNumber" :maxlength="40" style="width: 200px;" :disabled="true"></inputItem>
			      		</el-form-item>
		...
		<el-row>
			<el-col :span="14">
				<el-card class="box-card" style="margin-right: 5px; margin-top: 10px; margin-left: 5px;" shadow="hover">
				  <div slot="header" class="clearfix">
					...
					<el-table-column v-if="this.form.orignMethod==2" prop="subverName" label="子版本" min-width="100"></el-table-column>
				    ...
				    <el-table-column  label="操作" width="95px">
				      <template slot-scope="scope">
									<el-button-group>										
										<iconBtn iconClass="el-icon-minus" style="padding:5px 10px" content="删除" @click="deldetail(scope.$index,scope.row)"></iconBtn>
										<iconBtn iconClass="el-icon-edit" style="padding:5px 10px" content="分配货位" @click="automatic(scope.row)"></iconBtn>
			...
			<el-col :span="10">
				<el-card class="box-card" style="margin-right: 5px; margin-top: 10px; margin-left: 5px;" shadow="hover">
				  <div slot="header" class="clearfix" style="10px 5px">
					...
					<elemTable  style="padding:0" :dataList="dataList" :currentPage='pageNum' :pageSize="pageSize" :pageTotal="pageTotal" :loading="dataLoading" @sizeChange="handleSizeChange" @currentChange="handleCurrentChange">
					    ...
					    <el-table-column label="操作" width="80px">
					    	<template slot-scope="scope">
					    		<el-button-group>
									...
									<!--<iconBtn iconClass="el-icon-check" content="确认" @click="confirms(scope.row)" ></iconBtn>-->
					    		</el-button-group>		    		
					    	</template>
					    </el-table-column>
					</elemTable>
		...
		if(this.form.id==null){
  		...
  		for(var i= 0 ;i<tableArr.length;i++){
            ...
            Object.assign(this.form, {
			  ...
			  updatedDate : moment(Date.parse(new Date())).format("YYYY-MM-DD HH:mm:ss"),
            });
			...
			param: {mainorderId:this.form.id}, 
				...
				if(d.state === 0){
					...
					for (var i=0;i<this.detailtableData.length;i++) {		
					  ...
					  // this.subverNames = this.detailtableData[i].materVersions
