 ...
 * @since 1.0
 */
@TableName("t_ware_entrytraylocalmap")
public class EntrytraylocalmapEntity extends BaseEntity {
	...
	private java.math.BigDecimal realinQuality;
	...
	public java.math.BigDecimal getRealinQuality() {
		return realinQuality;
	}

	public void setRealinQuality(java.math.BigDecimal realinQuality) {
		this.realinQuality = realinQuality;
	}
    ...
    /** constructor */
	public EntrytraylocalmapEntity() {
		super();
	}
	 ...
	 */
	public EntrytraylocalmapEntity(Long orderdetailId,java.math.BigDecimal cigsmokeQuality,java.math.BigDecimal realinQuality,String trayRfid,Long localId,String localCode,String localRfid,java.util.Date createdDate,Long createdPersonId,String createdPerson,java.util.Date updatedDate,Long updatedPersonId,String updatedPerson,Long status,String batchNo,String soleCode,String trayCode,Long wareMethod,Integer isDelete){
		this();
		this.orderdetailId = orderdetailId;
		this.cigsmokeQuality = cigsmokeQuality;
		this.realinQuality = realinQuality;
	...
	public boolean equals(Object obj) {
		if (obj == null)
			return false;
		if(obj instanceof EntrytraylocalmapEntity == false)
			return false;
		if(this == obj)
			return true;
		EntrytraylocalmapEntity other = (EntrytraylocalmapEntity)obj;
