 ...
 * @since 1.0
 */
@TableName("t_base_matersubvermap")
public class MatersubvermapEntity extends BaseEntity {
	 ...
	 */
	public MatersubvermapEntity(String materCode,Long subverId,java.util.Date createdDate,Long createdPersonId,String createdPerson,java.util.Date updatedDate,Long updatedPersonId,String updatedPerson){
		this();
		this.materCode = materCode;
		this.subverId = subverId;
		this.createdDate = createdDate;
	...
	public String toString() {
		return new StringBuilder().append("MatersubvermapEntity[")
	...
	public boolean equals(Object obj) {
		if (obj == null)
			return false;
		if(obj instanceof MatersubvermapEntity == false)
			return false;
		if(this == obj)
			return true;
		MatersubvermapEntity other = (MatersubvermapEntity)obj;
