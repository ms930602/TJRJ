...
public class TpreSellMsEntity extends BaseEntity {
	 ...
	 */
	public TpreSellMsEntity(Long itemId,java.math.BigDecimal quantity,java.math.BigDecimal price,java.util.Date time,String remark,java.util.Date createtime){
		this();
		this.itemId = itemId;
		this.quantity = quantity;
		this.price = price;
	...
	public String toString() {
		return new StringBuilder().append("TpreSellMsEntity[")
	...
	public boolean equals(Object obj) {
		if (obj == null)
			return false;
		if(obj instanceof TpreSellMsEntity == false)
			return false;
		if(this == obj)
			return true;
		TpreSellMsEntity other = (TpreSellMsEntity)obj;
