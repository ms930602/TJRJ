 ...
 * @since 1.0
 */
@TableName("t_mater_tarvalegrade")
public class TarvalegradeEntity extends BaseEntity {
	...
	@JsonIgnore
	public String getTarCodeByLike() {
		return "%"+this.tarCode+"%";
	}
	...
	@JsonIgnore
	public String getTarNameByLike() {
		return "%"+this.tarName+"%";
	}
	 ...
	 */
	public TarvalegradeEntity(String dataId,String tarCode,String tarName,String status,java.util.Date createdDate,String createdPerson,java.util.Date updatedDate,String updatedPerson){
		this();
		this.dataId = dataId;
		this.tarCode = tarCode;
		this.tarName = tarName;
	...
	public String toString() {
		return new StringBuilder().append("TarvalegradeEntity[")
			.append("Id=").append(getId()).append(", ")
			.append("DataId=").append(getDataId()).append(", ")
			.append("TarCode=").append(getTarCode()).append(", ")
			.append("TarName=").append(getTarName()).append(", ")
	...
	public boolean equals(Object obj) {
		if (obj == null)
			return false;
		if(obj instanceof TarvalegradeEntity == false)
			return false;
		if(this == obj)
			return true;
		TarvalegradeEntity other = (TarvalegradeEntity)obj;
