 ...
 * @since 1.0
 */
@TableName("t_base_discreterestructrules")
public class DiscreterestructrulesEntity extends BaseEntity {
	...
	@Length(max=45,message="名称最大长度为45个字符")
	private String name;
	
	/** 阈值. */
	@Min(value=0,message="阀值不能小于0")
	@NotNull(message="阀值不能为空")
	private java.math.BigDecimal threshold;
	
	/** 备注. */
	@Length(max=100,message="备注最大长度为100个字符")
	...
	@JsonIgnore
	public java.math.BigDecimal getThresholdByLike() {
		return this.threshold;
	}
    ...
    /** constructor */
	public DiscreterestructrulesEntity() {
		super();
	}
	 ...
	 */
	public DiscreterestructrulesEntity(String name,java.math.BigDecimal threshold,String remark,java.util.Date createdDate,Long createdPersonId,String createdPerson,java.util.Date updatedDate,Long updatedPersonId,String updatedPerson){
		this();
		this.name = name;
		this.threshold = threshold;
		this.remark = remark;
	...
	public String toString() {
		return new StringBuilder().append("DiscreterestructrulesEntity[")
	...
	public boolean equals(Object obj) {
		if (obj == null)
			return false;
		if(obj instanceof DiscreterestructrulesEntity == false)
			return false;
		if(this == obj)
			return true;
		DiscreterestructrulesEntity other = (DiscreterestructrulesEntity)obj;
