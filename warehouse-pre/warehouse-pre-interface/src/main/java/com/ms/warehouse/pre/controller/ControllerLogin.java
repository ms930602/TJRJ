...
import com.ms.warehouse.pre.service.SessionHandler;
import com.ms.warehouse.pre.utils.Constants;
import com.ms.warehouse.pre.utils.CookieUtils;
...
public class ControllerLogin {
	...
	private void createSession(HttpServletRequest request, LoginRespVo resp) {
		...
		session.setAttribute(com.ms.warehouse.common.Constants.SESSION_LOGIN_USER, resp.getSessionUser());
		session.setAttribute(com.ms.warehouse.common.Constants.REQUEST_CLIENT_IP, Utils.getIpAddr(request));
