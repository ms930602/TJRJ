<template>
		<el-dialog custom-class="jz-modal" :title="modaltype === 'add' ? '新增车载终端' : '编辑车载终端'" :visible="modalshow"  :before-close="beforeClose" :width="modalWidth" :close-on-click-modal="false">
