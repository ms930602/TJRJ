 ...
 */
@TableName("t_game_ms")
public class TgameMsEntity extends BaseEntity {
	 ...
	 * @param columnD			扩展字段4
	 */
	public TgameMsEntity(String name,Long type,java.util.Date createtime,Long columnA,Long columnB,String columnC,String columnD){
		this();
		this.name = name;
		this.type = type;
		this.createtime = createtime;
	...
	public String toString() {
		return new StringBuilder().append("TgameMsEntity[")
	...
	public boolean equals(Object obj) {
		if (obj == null)
			return false;
		if(obj instanceof TgameMsEntity == false)
			return false;
		if(this == obj)
			return true;
		TgameMsEntity other = (TgameMsEntity)obj;
