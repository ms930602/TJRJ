 ...
 */
@TableName("t_sell_ms")
public class TsellMsEntity extends BaseEntity {
	 ...
	 */
	public TsellMsEntity(Long itemId,java.math.BigDecimal quantity,java.math.BigDecimal price,java.util.Date sellTime,String remark,java.util.Date createtime){
		this();
		this.itemId = itemId;
		this.quantity = quantity;
		this.price = price;
	...
	public String toString() {
		return new StringBuilder().append("TsellMsEntity[")
	...
	public boolean equals(Object obj) {
		if (obj == null)
			return false;
		if(obj instanceof TsellMsEntity == false)
			return false;
		if(this == obj)
			return true;
		TsellMsEntity other = (TsellMsEntity)obj;
